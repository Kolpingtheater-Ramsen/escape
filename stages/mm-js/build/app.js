class Ghost {
  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === 'scared') {
      ...
      this.animationTarget.style.backgroundImage =
        'url(app/style/graphics/' + `spriteSheets/characters/ghosts/eyes.png)`
    } else {
      this.animationTarget.style.backgroundImage =
        'url(app/style/graphics/' +
        `spriteSheets/characters/ghosts/${name}/${name}.png)`
    }
  }
   ...
   */
  toggleScaredColor() {
    this.scaredColor = this.scaredColor === '1' ? '2' : '1'
    this.setSpriteSheet(this.name, this.direction, this.mode)
  }
...
class GameCoordinator {
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgSources = [
        ...
        // Blinky
        `${imgBase}characters/ghosts/blinky/blinky.png`,

        // Clyde
        `${imgBase}characters/ghosts/clyde/clyde.png`,

        // Inky
        `${imgBase}characters/ghosts/inky/inky.png`,

        // Pinky
        `${imgBase}characters/ghosts/pinky/pinky.png`,

        // Ghosts Common
        `${imgBase}characters/ghosts/eyes.png`,
        `${imgBase}characters/ghosts/scared_1.png`,
        `${imgBase}characters/ghosts/scared_2.png`,
  ...
  displayText(position, amount, duration, width, height) {
    ...
    pointsDiv.style.backgroundImage =
      'url(app/style/graphics/' + `spriteSheets/text/${amount}.png`
